...
Task::Task(TypeTask typeTask, Node *start, Node *end, QGraphicsItem *parent, QGraphicsScene *scene)
...
void Task::removeNodes(Task *task)
{
    startNode->removeTask(task);
    endNode->removeTask(task);
}
